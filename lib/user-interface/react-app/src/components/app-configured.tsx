  ...
  useEffect(() => {
    (async () => {
      try {     
        ...
        awsExports["Auth"] = {
    "region": "us-east-1",
    "userPoolId": "us-east-1_bs0dwfmGY",
    "userPoolWebClientId": "3ohhhk6ukisdqafkvp26srjcs2",
    "oauth": {
      "domain": "non-prod-genie.auth.us-east-1.amazoncognito.com",
      "scope": ["email", "openid", "profile"],
      "redirectSignIn": "https://dxsig7voh7at2.cloudfront.net/",
